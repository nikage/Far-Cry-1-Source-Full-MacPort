...
/*      if(fPrevDist0 >= m_fDistance0 && 
      ...
      objMatrix.SetTranslationMat(rParms.vPos+pBodyLow->GetCenter()*m_fScale);
      ...
      objMatrix.SetTranslationMat(objMatrix.GetTranslationOLD() - pBodyLow->GetCenter()*m_fScale);
