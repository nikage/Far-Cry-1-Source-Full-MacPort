...
private: // -------------------------------------------------------------------------
	...
	DWORD Debug_Buckets_recursive(IScriptObject *pCurrent, const string &sPath, std::set<const void *> &setVisited, DWORD dwMinBucket);

	//! not recursive
	void Debug_Elements( IScriptObject *pCurrent, string &sPath, std::set<const void *> &setVisited );

	//! recursive
	void Debug_Full_recursive(IScriptObject *pCurrent, const string &sPath, std::set<const void *> &setVisited);
};
