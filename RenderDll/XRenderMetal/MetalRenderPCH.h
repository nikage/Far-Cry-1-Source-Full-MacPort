...
static const NSUInteger kMetalPerShaderFragmentUniformSlot = 2; // fragment — per-shader generated uniforms
static const NSUInteger kMetalPerShaderVertexUniformSlot   = 5; // vertex   — per-shader generated uniforms (beyond water noise at 4)
