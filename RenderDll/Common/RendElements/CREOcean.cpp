...
#if !defined(_XBOX) && !defined(WIN64) && !defined(LINUX) && !defined(__APPLE__)
	// NOTE: AMD64 port: implement
  if ((g_CpuFlags & CPUF_SSE) && CRenderer::CV_r_sse && !(((intptr_t)&cmpX[0][0]) & 0xf) && !(((intptr_t)&cmpY[0][0]) & 0xf) && OCEANGRID == 64)
  {
