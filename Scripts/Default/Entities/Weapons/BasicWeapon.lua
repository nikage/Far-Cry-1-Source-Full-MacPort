...
BasicWeapon = {
	...
	blip=Sound and call(Sound.LoadSound,{Sound,"SOUNDS/hit.wav",0,128},"x") or nil,
	fireModeChangeSound=Sound and call(Sound.LoadSound,{Sound,"SOUNDS/items/WEAPON_FIRE_MODE.wav",0,128},"x") or nil,
	Client = {},
	Server = {},
